...
module.exports = class RTCSession extends EventEmitter
{
  ...
  answer(options = {})
  {
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
          console.log('Answer Get mediastream ',this._ua._mediaStream);
        ...
        else if (this._ua._mediaStream) {
            return this._ua._mediaStream;
        }
      ...
      .then(() =>
      {
        ...
        return new Promise((resolve) =>
        {
          ...
          const ready = () =>
          {
            ...
            //recreate the offer
            let promise = type === 'offer'
              ? (new Promise((resolve, reject) => connection.createOffer(resolve, reject, constraints)))
              : (new Promise((resolve, reject) => connection.createAnswer(resolve, reject, constraints)));
            promise.then(desc => {
              finished = true;
              this._rtcReady = true;

              const e = { originator: 'local', type: type, sdp: desc.sdp };
  ...
  _sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream)
  {
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
          ...
          console.log('InitRequest Get mediastream ',this._ua._mediaStream);
